    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link px-3" href="maquinas.php"><i class="bi bi-cpu"></i> Inventario</a></li>
                <li class="nav-item"><a class="nav-link px-3" href="registro_ticket.php"><i class="bi bi-plus-circle"></i> Nuevo Ticket</a></li>
            </ul>
        </div>
    </div>
</nav>
