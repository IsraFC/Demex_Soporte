 ...
 * DESCRIPCIÓN: Formulario inteligente con precarga automática de Catálogos Oficiales.
 * @author Sergio Mauricio Campos Carranza
 * @project Módulo Ventas DEMEX
 * @version 2.3 (Soporte extendido para imágenes opcionales en Maquinaria, Bases y Saborizantes)
 */
...
$catalogo_maquinas = [
    ...
    'DEMEX 613'   => ['publico' => 88000.00,  'distribuidor' => 74000.00,  'linea' => 'Demex', 'tipo' => 'Bifásica 220V/60Hz',    'capacidad' => '46-52 Lts x Hora','desc' => 'MAQUINARIA INDUSTRIAL BIFÁSICA PARA ALTA DEMANDA.'],
...
<div class="card-main mb-4 py-4 px-4 shadow-sm border-top border-4 border-danger bg-white rounded animate__animated animate__fadeInUp">
    ...
    <form action="../actions/procesar_alta_producto.php" method="POST" id="formAltaProducto" enctype="multipart/form-data">
        ...
        <div id="bloque_maquinas" class="bloque-dinamico border-top pt-3 mt-3" style="display: none;">
            <h6 class="fw-bold text-danger mb-3"><i class="bi bi-cpu me-2"></i> Especificaciones Técnicas e Imagen</h6>
            <div class="row g-3 mb-3">
                <div class="col-12 col-md-3">
            ...
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    <label class="form-label fw-semibold text-dark small"><i class="bi bi-image text-danger me-1"></i> Fotografía del Equipo (Opcional - formato PNG)</label>
                    <input type="file" class="form-control border-secondary shadow-sm foto-input-control" name="foto_producto_maq" accept="image/png">
                    <div class="form-text small text-muted">Deja este campo vacío si no deseas asignar una imagen.</div>
                </div>
            </div>
        </div>

        <!-- Bloque Insumos (MODIFICADO: Se añade sección de imagen para bases o saborizantes) -->
        <div id="bloque_insumos" class="bloque-dinamico border-top pt-3 mt-3" style="display: none;">
            ...
            <!-- AGREGADO: Carga opcional de imágenes para materias primas -->
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    <label class="form-label fw-semibold text-dark small"><i class="bi bi-image text-danger me-1"></i> Fotografía del Insumo / Materia Prima (Opcional - formato PNG)</label>
                    ...
                    <div class="form-text small text-muted">Deja este campo vacío si no deseas asignar una imagen comercial.</div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    // === INTERCEPCIÓN ASÍNCRONA CON FORMDATA ===
    ...
    $('#id_categoria').on('change', function() {
        ...
        $('#descripcion').val('');
        $('.foto-input-control').val(''); // Reseteamos de forma limpia los campos de archivos
